...
#   name_boat = element.attr('h3')
  ...
  boat_one = Boat.create!(
    name: "FIRST 21",
    category: "Voilier",
    price_per_day: 115,
    photo: cl_image_tag("boat1.jpg"),
...
"
    ...
    user_id: 17)
        ...
        <option value="Sailboat">Voilier</option>
              ...
              <option value="Houseboat">Péniche</option>
